<template>
  <v-container fluid class="mt-3">
    <v-layout wrap align-center justify-center row fill-height>
      <v-flex xs12 md12>
        <p class="google-font mt-2 mb-0" style="font-size:160%;color:#37474F;">
          Partners
        </p>
        ...
        <v-layout class="transparent">
          <v-flex xs12 sm10 class="elevation-0 transparent">
            <v-card class="elevation-0 pa-0 ma-0 transparent">
              <v-container grid-list-sm fluid class="pa-0 ma-0">
                <v-layout row wrap class="ma-0 pa-0">
                  <v-flex xs6 md2 d-flex class="transparent elevation-0">
                    <v-card
                      flat
                      tile
                      class="d-flex pa-2 ma-1 elevation-1"
                      style="border-radius:5px;border-width: 1px; border-style: solid;"
                    >
                      <a href="https://gdgjalandhar.com" target="_blank">
                        <v-tooltip bottom>
                          <template v-slot:activator="{ on }">
                            <v-img
                              :src="
                                require('@/assets/img/partners/gdgjalandhar.png')
                              "
                              :lazy-src="
                                require('@/assets/img/partners/gdgjalandhar.png')
                              "
