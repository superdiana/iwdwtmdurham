      ...
      <v-layout wrap align-center justify-center row fill-height class="pa-3">
        <v-flex xs12 md8 lg8>
          <span
            ...
            style="border-radius:8px;background-color:#F9FBE7;color:#827717;font-size:150%"
            >Speakers</span
          >
          <p class="google-font mt-2" style="color:#37474F;font-size:150%">
            Our lineup of amazing speakers!
          </p>
          <p class="mt-0 google-font subheading">
            Get ready to be inspired by speakers who are making a difference in
            the tech ecosystem. Stay tuned as we add more dynamic speakers to
            our lineup..
          </p>
        </v-flex>
          ...
          <v-layout wrap row fill-height class="pa-0">
            ...
            >
              ...
              >
                ...
                <p class="mt-3 mb-0 google-font" style="font-size:120%">
                  {{ item.name }}
                </p>
