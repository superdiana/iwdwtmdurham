<template>
    <v-slide-y-reverse-transition>
        <div>
        <v-container fluid v-show="show" class="mt-3 blue" style="border-bottom-right-radius:30%;background-size:2000px" :style="{'background-image':'url('+require('@/assets/img/bgwtm.jpg')+')'}" >
